...
__webpack_require__.d(__webpack_exports__, {
  ...
  SUPPORTED_PAYMENT_NETWORK: () => (/* reexport */ SUPPORTED_PAYMENT_NETWORK),
  TORUS_BUILD_ENV: () => (/* reexport */ TORUS_BUILD_ENV),
  TorusInpageProvider: () => (/* reexport */ inpage_provider),
  WALLET_OPENLOGIN_VERIFIER_MAP: () => (/* reexport */ WALLET_OPENLOGIN_VERIFIER_MAP),
  WALLET_VERIFIERS: () => (/* reexport */ WALLET_VERIFIERS),
...
class TorusInpageProvider extends openlogin_jrpc_namespaceObject.SafeEventEmitter {
  constructor(connectionStream) {
    ...
    // private state
    this._state = objectSpread2_default()({}, TorusInpageProvider._defaultState);
