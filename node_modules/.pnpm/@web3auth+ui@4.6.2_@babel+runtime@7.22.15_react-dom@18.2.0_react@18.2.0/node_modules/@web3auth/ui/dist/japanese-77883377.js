var modal = {
	"adapter-loader.message": "続行するには、{{adapter}} アカウントで確認してください",
	"external.title": "外部ウォレット",
	"social.view-less-new": "表示を減らす",
	"footer.message": "による自己管理ログイン",
	"network.switch-request": "このサイトはネットワークの切り替えを要求しています",
	"footer.terms": "利用規約",
	"footer.message-new": "Web3Authによる自己管理ログイン",
	"network.to": "に",
	"external.walletconnect-subtitle": "WalletConnect対応ウォレットでQRコードをスキャン",
	"external.walletconnect-copy": "QRコードをクリックしてクリップボードにコピー",
	"social.policy": "ソーシャル ログインに関連するデータは保存されません。",
	"external.walletconnect-connect": "接続",
	...
	"adapter-loader.message1": "{{adapter}} で確認する",
	...
	"adapter-loader.message2": "継続するアカウント",
	"network.from": "から",
...
//# sourceMappingURL=japanese-77883377.js.map
