var modal = {
	...
	"social.view-less-new": "weniger sehen",
	"footer.message": "Selbstverwahrungs-Login durch",
	"network.switch-request": "Diese Website fordert einen Netzwerkwechsel an",
	"footer.terms": "Nutzungsbedingungen",
	"footer.message-new": "Self-custodial Login durch Web3Auth",
	"network.to": "Zu",
	"external.walletconnect-subtitle": "QR-Code mit einem WalletConnect-kompatiblen Wallet scannen",
	...
	"network.cancel": "Absagen",
	"social.view-more-new": "Mehr sehen",
	"social.email": "Email",
	"external.connect": "Verbinden Sie sich mit Wallet",
	"network.proceed": "Fortfahren",
	"header-subtitle": "Wählen Sie eine der folgenden Optionen aus, um fortzufahren",
	"adapter-loader.message1": "Bestätigen Sie auf Ihrem {{adapter}}",
	"footer.version": "Ausführung",
	"social.view-more": "Weitere Optionen anzeigen",
	"header-title": "Einloggen",
	"header-subtitle-new": "Ihre Blockchain-Wallet mit einem Klick",
	"header-subtitle-name": "Ihre {{appName}}-Brieftasche mit einem Klick",
	"header-tooltip-title": "Brieftasche",
	"header-tooltip-desc": "Die Brieftasche dient Ihnen als Konto zum Speichern und Verwalten Ihrer digitalen Assets in der Blockchain.",
	"footer.terms-service": "Nutzungsbedingungen",
	"social.email-continue": "Fahren Sie mit E-Mail fort",
	"social.continue": "Weitermachen mit",
	"external.back": "Der Rücken",
	"network.add-request": "Diese Website fordert das Hinzufügen eines Netzwerks an",
	"social.email-new": "name@beispiel.com",
	"footer.policy": "Datenschutz-Bestimmungen",
...
//# sourceMappingURL=german-fbdd41d8.js.map
