...
function DetailedLoader(props) {
  ...
  const web3authIcon = /*#__PURE__*/jsx(Image$1, {
    imageId: "web3auth"
  });
  const providerIcon = /*#__PURE__*/jsx(Image$1, {
...
function Loader(props) {
  ...
  return modalStatus !== MODAL_STATUS.INITIALIZED ? /*#__PURE__*/jsxs("div", {
    ...
    children: [/*#__PURE__*/jsxs("div", {
      ...
      children: [/*#__PURE__*/jsxs("div", {
        className: "w3a-modal__loader-info",
        children: [modalStatus === MODAL_STATUS.CONNECTING && /*#__PURE__*/jsxs("div", {
  ...
  return /*#__PURE__*/jsx("div", {
    ...
    children: /*#__PURE__*/jsxs("div", {
      ...
      children: [showBackButton && /*#__PURE__*/jsxs("button", {
        ...
        return null;
      }), modalStatus === MODAL_STATUS.INITIALIZED && /*#__PURE__*/jsx("ul", {
        ...
        children: externalButtons.map(button => {
          ...
          return /*#__PURE__*/jsx("li", {
            ...
            }, button.name) : /*#__PURE__*/jsxs("button", {
              type: "button",
...
class LoginModal extends SafeEventEmitter {
  constructor(_uiConfig) {
    ...
    _defineProperty(this, "initModal", async () => {
      ...
      if (useLang === "de") {
        import('./german-4ae2ee33.js').then(messages => {
        ...
        import('./japanese-e1a7a06c.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./korean-95658e12.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./mandarin-1e325876.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./spanish-54ba83ea.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./french-3d857bc5.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./portuguese-c1293d6a.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
        ...
        import('./dutch-9a1ae5c2.js').then(messages => {
          i18n.addResourceBundle(useLang, "translation", messages.default);
          return i18n.changeLanguage(useLang);
        }).catch(error => {
          log.error(error);
...
function AddNetwork(props) {
  ...
  return showModal && /*#__PURE__*/jsx("div", {
...
class NetworkSwitch extends BaseNetworkSwitch {
  async addNetwork(params) {
    ...
    return new Promise((resolve, reject) => {
      ...
      networkRoot.render( /*#__PURE__*/jsx(AddNetwork, {
        appOrigin: appOrigin,
  ...
  async switchNetwork(params) {
    ...
    return new Promise((resolve, reject) => {
      ...
      networkRoot.render( /*#__PURE__*/jsx(SwitchNetwork, {
        appOrigin: appOrigin,
...
export { DEFAULT_LOGO_DARK, DEFAULT_LOGO_LIGHT, LOGIN_MODAL_EVENTS, LoginModal, MODAL_STATUS, NetworkSwitch, OPENLOGIN_PROVIDERS, OPENLOGIN_PROVIDERS_NAMES, WALLET_CONNECT_LOGO, capitalizeFirstLetter, LoginModal as default, getAdapterSocialLogins, getNetworkIconId, getUserCountry, getUserLanguage, languageMap, passwordlessBackendUrl, validateImageUrl, validatePhoneNumber };
