...
/* harmony export */ });
/* harmony import */ var _babel_runtime_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(56);
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(195);
...
/* harmony import */ var _createSwappableProxy__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(868);
/* harmony import */ var _CommunicationMethodMiddleware__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(469);
...
class BaseEmbedController extends _BaseController__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z {
  ...
  initializeProvider(handlers) {
    ...
    const communicationMiddleware = (0,_CommunicationMethodMiddleware__WEBPACK_IMPORTED_MODULE_3__/* .createCommunicationMiddleware */ .u_)(handlers);
    engine.push(communicationMiddleware);
    const communicationProvider = (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.providerFromEngine)(engine);
  ...
  setCommunicationProvider(communicationProvider) {
    if (this._communicationProviderProxy) {
      ...
      this._communicationProviderProxy = (0,_createSwappableProxy__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z)(communicationProvider);
    }
  }
}
...
function createChangeProviderMiddlewareMiddleware(_ref) {
  ...
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createAsyncMiddleware)(async (request, response, next) => {
    ...
    if (method !== _enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.SET_PROVIDER) return next();
...
function createTopupMiddleware(_ref2) {
  ...
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.createAsyncMiddleware)(async (request, response, next) => {
    ...
    if (method !== _enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.TOPUP) return next();
...
function createCommunicationMiddleware(providerHandlers) {
  ...
  return (0,_toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_0__.mergeMiddleware)([createChangeProviderMiddlewareMiddleware({
    ...
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.LOGOUT]: logout,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.WALLET_INSTANCE_ID]: getWalletInstanceId,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.USER_INFO]: getUserInfo,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.IFRAME_STATUS]: setIFrameStatus,
    // Do this in the orchestrator because communicationWindowManager needs to be passed into PopupHandlers
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.OPENED_WINDOW]: handleWindowRpc,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.CLOSED_WINDOW]: handleWindowRpc,
    [_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.GET_PROVIDER_STATE]: getProviderState
  }), createGenericJRPCMiddleware(_enums__WEBPACK_IMPORTED_MODULE_1__/* .COMMUNICATION_JRPC_METHODS */ .vU.LOGIN_WITH_PRIVATE_KEY, loginWithPrivateKey)]);
}
...
class CommunicationWindowManager extends _toruslabs_openlogin_jrpc__WEBPACK_IMPORTED_MODULE_1__.SafeEventEmitter {
  constructor() {
    ...
    _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_0___default()(this, "handleWindowRpc", (request, response, next, end) => {
      ...
      if (method === _enums__WEBPACK_IMPORTED_MODULE_2__/* .COMMUNICATION_JRPC_METHODS */ .vU.OPENED_WINDOW) {
        const {
          windowId
        } = params;
      ...
      } else if (method === _enums__WEBPACK_IMPORTED_MODULE_2__/* .COMMUNICATION_JRPC_METHODS */ .vU.CLOSED_WINDOW) {
        const {
          windowId
        } = params;
...
"use strict";
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   H: () => (/* binding */ createRandomId)
/* harmony export */ });
...
__webpack_require__.d(__webpack_exports__, {
  D: () => (/* binding */ createFetchConfigFromReq),
  v: () => (/* binding */ createFetchMiddleware)
});
...
function checkForHttpErrors(fetchRes) {
  ...
  switch (fetchRes.status) {
    case 405:
      throw rpc_errors_namespaceObject.rpcErrors.methodNotFound();
    case 418:
      throw rpc_errors_namespaceObject.rpcErrors.internal({
...
function createFetchMiddleware(_ref2) {
  ...
  return (0,openlogin_jrpc_.createAsyncMiddleware)(async (req, res, _next) => {
    const {
      fetchUrl,
      fetchParams
...
class StreamWindow extends BaseController/* default */.Z {
    ...
    return new Promise((resolve, reject) => {
      ...
      if (!this.state.windowId) {
        ...
        communicationEngine.emit("notification", {
          method: enums/* COMMUNICATION_NOTIFICATIONS */.Nb.CREATE_WINDOW,
          params: {
  ...
  close() {
    ...
    communicationEngine.emit("notification", {
      method: enums/* COMMUNICATION_NOTIFICATIONS */.Nb.CLOSE_WINDOW,
      params: {
        windowId: this.state.windowId
      }
    });
...
class PopupStoreChannel {
  ...
  logoutChannel() {
    const logoutChannel = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.WALLET_LOGOUT_CHANNEL}_${this.instanceId}`, utils/* broadcastChannelOptions */.aN);
    logoutChannel.addEventListener("message", ev => {
      var _ev$data;
      external_loglevel_default().info("received logout message", ev);
      if (!ev.error && ((_ev$data = ev.data) === null || _ev$data === void 0 ? void 0 : _ev$data.type) === enums/* BROADCAST_CHANNELS_MSGS */.$x.LOGOUT) {
  ...
  importAccountChannel() {
    const walletAccountImportChannel = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.WALLET_ACCOUNT_IMPORT_CHANNEL}_${this.instanceId}`, utils/* broadcastChannelOptions */.aN);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data2;
      if (!ev.error && ((_ev$data2 = ev.data) === null || _ev$data2 === void 0 ? void 0 : _ev$data2.type) === enums/* BROADCAST_CHANNELS_MSGS */.$x.ACCOUNT_IMPORTED) {
        var _ev$data3;
  ...
  networkChangeChannel() {
    const walletAccountImportChannel = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.WALLET_NETWORK_CHANGE_CHANNEL}_${this.instanceId}`, utils/* broadcastChannelOptions */.aN);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data4;
      if (!ev.error && ((_ev$data4 = ev.data) === null || _ev$data4 === void 0 ? void 0 : _ev$data4.type) === enums/* BROADCAST_CHANNELS_MSGS */.$x.NETWORK_CHANGE) {
        var _ev$data5;
  ...
  themeChangedChannel() {
    const walletAccountImportChannel = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.THEME_CHANGE}_${this.instanceId}`, utils/* broadcastChannelOptions */.aN);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data6;
      external_loglevel_default().info({
        ev
      });
      if (!ev.error && ((_ev$data6 = ev.data) === null || _ev$data6 === void 0 ? void 0 : _ev$data6.type) === enums/* BROADCAST_CHANNELS_MSGS */.$x.SET_THEME) {
        var _ev$data7;
  ...
  selectedAddressChangeChannel() {
    const walletAccountImportChannel = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.WALLET_SELECTED_ADDRESS_CHANNEL}_${this.instanceId}`, utils/* broadcastChannelOptions */.aN);
    walletAccountImportChannel.addEventListener("message", ev => {
      var _ev$data8;
      if (!ev.error && ((_ev$data8 = ev.data) === null || _ev$data8 === void 0 ? void 0 : _ev$data8.type) === enums/* BROADCAST_CHANNELS_MSGS */.$x.SELECTED_ADDRESS_CHANGE) {
        var _ev$data9;
    ...
    return new Promise((resolve, reject) => {
      ...
      try {
        if (!finalQueryParams.windowId) {
          bc = new broadcast_channel_namespaceObject.BroadcastChannel(`${enums/* BROADCAST_CHANNELS */.kl.REDIRECT_CHANNEL}_${instanceParameters.instanceId}`, utils_utils/* broadcastChannelOptions */.aN);
          bc.addEventListener("message", async ev => {
            if (ev.error) {
              reject(ev.error);
              window.close();
...
var objectSpread2_ = __webpack_require__(56);
...
const DEFAULT_PREFERENCES = {
  ...
  theme: "dark",
  locale: "en-US",
  accountType: IPreferencesController/* ACCOUNT_CATEGORY */.O.NORMAL,
  contacts: [],
  jwtToken: "",
  fetchedPastTx: [],
  pastTransactions: [],
  ...
  userInfo: {
    ...
    name: "",
    profileImage: "",
    typeOfLogin: interfaces/* LOGIN_PROVIDER */.h.GOOGLE,
    verifier: "",
    verifierId: ""
  }
};
...
class BasePreferencesController extends BaseController/* default */.Z {
  ...
  async init(address, userInfo, jwtToken, pubKey, type) {
    let response = {
      token: jwtToken
    };
...
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(195);
/* harmony import */ var _babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_defineProperty__WEBPACK_IMPORTED_MODULE_1__);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(793);
/* harmony import */ var lodash__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(lodash__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _BaseController__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(758);
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(883);
/* harmony import */ var _ITransactionController__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(664);
...
class BaseTransactionStateManager extends _BaseController__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z {
  constructor(_ref) {
    let {
      config,
      state,
  ...
  getUnapprovedTxList() {
    ...
    return (0,lodash__WEBPACK_IMPORTED_MODULE_2__.pickBy)(this.state.transactions, transaction => transaction.status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.unapproved && (0,_utils__WEBPACK_IMPORTED_MODULE_4__/* .transactionMatchesNetwork */ .lw)(transaction, chainId));
  }
  getTransaction(txId) {
    const {
      transactions
  ...
  setTxStatusRejected(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.rejected);
  ...
  setTxStatusUnapproved(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.unapproved);
  }
  setTxStatusApproved(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.approved);
  }
  setTxStatusSigned(txId, isFinalStep) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.signed, isFinalStep);
  }
  setTxStatusSubmitted(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.submitted);
  }
  setTxStatusDropped(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.dropped);
  }
  setTxStatusExpired(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.expired);
  }
  setTxStatusConfirmed(txId) {
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.confirmed);
  }
  setTxStatusFailed(txId, error_) {
    ...
    this._setTransactionStatus(txId, _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.failed);
  }
   ...
   */
  isFinalState(status) {
    return status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.rejected || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.submitted || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.confirmed || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.failed || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.cancelled || status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.expired;
  }
  ...
  clearUnapprovedTxs() {
    this.update({
      transactions: (0,lodash__WEBPACK_IMPORTED_MODULE_2__.omitBy)(this.state.transactions, transaction => transaction.status === _ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TransactionStatus */ .LN.unapproved)
    });
  }
  ...
  _setTransactionStatus(txId, status, isFinalStep) {
    ...
    this.updateTransaction(txMeta);
    this.emit(_ITransactionController__WEBPACK_IMPORTED_MODULE_5__/* .TX_EVENTS */ .RM.TX_STATUS_UPDATE, {
      txId,
      status
    });
...
/* harmony export */   E$: () => (/* binding */ ACTIVITY_ACTION_CREATE_NFT_OFFER),
...
/* harmony export */   Y7: () => (/* binding */ ACTIVITY_ACTION_CREATE_TRUSTLINE),
/* harmony export */   Ye: () => (/* binding */ ACTIVITY_ACTION_REMOVE_TRUSTLINE),
...
/* harmony export */   lj: () => (/* binding */ ACTIVITY_ACTION_CANCEL_NFT_OFFER),
...
/* harmony export */   wA: () => (/* binding */ ACTIVITY_ACTION_ACCEPT_NFT_OFFER),
...
/* harmony export */   ACTIVITY_ACTION_ACCEPT_NFT_OFFER: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.wA),
...
/* harmony export */   ACTIVITY_ACTION_CANCEL_NFT_OFFER: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.lj),
/* harmony export */   ACTIVITY_ACTION_CREATE_NFT_OFFER: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.E$),
/* harmony export */   ACTIVITY_ACTION_CREATE_TRUSTLINE: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.Y7),
/* harmony export */   ACTIVITY_ACTION_RECEIVE: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.qU),
/* harmony export */   ACTIVITY_ACTION_REMOVE_TRUSTLINE: () => (/* reexport safe */ _enums__WEBPACK_IMPORTED_MODULE_9__.Ye),
...
/* harmony export */   createRandomId: () => (/* reexport safe */ _Network_INetworkController__WEBPACK_IMPORTED_MODULE_15__.H),
...
/* harmony import */ var _Network_createFetchMiddleware__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(928);
...
/* harmony import */ var _Network_INetworkController__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(735);
