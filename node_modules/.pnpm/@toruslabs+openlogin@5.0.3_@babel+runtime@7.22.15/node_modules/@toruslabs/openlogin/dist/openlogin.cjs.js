...
function getHashQueryParams() {
  ...
  if (replaceUrl) {
    ...
    if (hashResult) {
      ...
      cleanUrl.hash = (0,openlogin_utils_namespaceObject.safebtoa)(JSON.stringify(hashParams));
    }
...
class OpenLogin {
  ...
  get baseUrl() {
    ...
    if (this.options.buildEnv === openlogin_utils_namespaceObject.BUILD_ENV.DEVELOPMENT || this.options.buildEnv === openlogin_utils_namespaceObject.BUILD_ENV.TESTING) return `${this.options.sdkUrl}`;
  ...
  async changeSocialFactor(params) {
    ...
    const dataObject = {
      actionType: openlogin_utils_namespaceObject.OPENLOGIN_ACTIONS.MODIFY_MFA,
      options: this.options,
      params: objectSpread2_default()(objectSpread2_default()({}, defaultParams), params),
      sessionId: this.sessionId
    };
